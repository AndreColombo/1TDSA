...
match conceito:
    case 'A':
        print(f'{nomeAluno} está aprovado na disciplina {disciplina}, com conceito "A" e média {media:.1f}')
    case 'B':
        print(f'{nomeAluno} está aprovado na disciplina {disciplina}, com conceito "B" e média {media:.1f}')
    case 'C':
        print(f'{nomeAluno} está aprovado na disciplina {disciplina}, com conceito "C" e média {media:.1f}')
    case 'D':
        print(f'{nomeAluno} está aprovado na disciplina {disciplina}, com conceito "D" e média {media:.1f}')
    case 'E':
        print(f'{nomeAluno} está reprovado na disciplina {disciplina}, com conceito "E" e média {media:.1f}')
    case _:
